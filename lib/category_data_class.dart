class CategoryDataClass 
{
  ...
  CategoryDataClass({required this.CourseImage,required this.CourseName,required this.courseContent});
}

List<CategoryDataClass> courses = [
  CategoryDataClass(
      CourseImage: 'assets/images/Android.jpeg', CourseName: 'Android Course',courseContent: syllabus[0]),
  CategoryDataClass(
      CourseImage: 'assets/images/IOS.jpeg', CourseName: 'IOS Course',courseContent: syllabus[1]),
  CategoryDataClass(
      CourseImage: 'assets/images/fullStack.jpeg',
      CourseName: 'FullStack Course',courseContent: syllabus[2])
];

List<String> syllabus=['''Part 1 ( Java SE)
